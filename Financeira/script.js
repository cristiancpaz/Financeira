...
/*
function moveon() {
    var answer = confirm('Pronto para seguir em frente?');
    if (answer) window.location = 'http://rgxdigital.com.br';// se clica em ok abre o google
};
...
// elementos gráficos em um elemento <canvas>, basta retornar agora.
    ...
    g.font = "12px bold sans-serif";// Define uma fonte
    g.fillText("Total de Pagamentos com Juros ", 20,20);// Desenha texto na legenda
    ...
    g.fillText("Total Capital", 20,35);//Rotula em verde
...
// preta grossa no gráfico
    ...
    for(var year=1; year*12 <= payments; year++) {// Para cada ano Calcula a posição da marca
